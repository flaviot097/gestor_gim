        ...
        <div class="card">
            ...
            <div class="content">
                ...
                <div class="actions" style="align-items: center;">
                    <div>
                        <button type="submit" class="download" style="margin-left: 12vh">Eliminar usuario</button>
                    </div>
                </div>
                </form>
            </div>
    ...
    <div class="container-form">
        <div class="card">
            ...
            <div class="content">
                <span class="title">Sesion de usuario</span>
                <div class="desc">
                    <form action="./accion-validadar-session.php" method="post" class="form">
                        <label for="usuario" class="usuario">DNI:</label>
                        <input type="number" name="dni" class="usuario" required />
                        <br />
                ...
                <div class="actions">
                    <div>
                        <button type="button" class="notnow"> Crear Usuario</button>
                    </div>
                    <div>
                        <button type="submit" class="download">Iniciar sesion</button>
                    </div>
                </div>
                </form>
            </div>
